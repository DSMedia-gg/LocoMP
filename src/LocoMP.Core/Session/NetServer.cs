...
public sealed class NetServer : IDisposable
{
    ...
    public NetServer(ITransport transport, ServerConfig config, IClock clock)
    {
    ...
    /// <summary>Pump the transport; deliver everything queued since the last call.</summary>
